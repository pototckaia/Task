// MPI. Параллельный ввод/вывод. Работа с файлами. Доступ к данным. Коллективное чтение из файла

// Разобраться с новыми функциями, объяснить выполнение программы.
// Создать файл и заполнить его объемным текстом, выполните параллельный вывод содержимого.
// Измените шаг считывания содержимого файла и количество выводимых символов каждым процессом.
